...
export const MapFormSchema = z.object({
    ...
    description: z.string({ invalid_type_error: "Description is of invalid type" }).optional(),
...
export const PlaceFormSchema = z.object({
    id: z.number({ invalid_type_error: 'Id must be of type number', required_error: 'Id is required' }),
    ...
    description: z.string({ invalid_type_error: "Desscription msut be of type string." }).optional(),
...
export const CreatePlaceFormSchema = PlaceFormSchema.omit({ id: true })
