    ...
    return (
        <div className='px-2 w-64 flex flex-col text-left gap-1.5'>
            <div>
                ...
                <span className='inline ml-2 text-blue-400 text-[12px] italic'>{place.category.charAt(0).toUpperCase() + place.category.substring(1)}</span>
            </div>
            <hr />
            ...
            <div className='flex gap-1.5 mt-1'>
                ...
                <button className='bg-white hover:bg-gray-50 text-blue-600 border w-full py-1 rounded'>Adjust Location</button>
            </div>
        </div>
    )
}
